...
//   - CallMeta.RouteKey 写入 llm_invocation.role，按 trafficAnalysis / orchestrator /
//     exploitation / inspector 四角色维度聚合成本。
package llm
...
// 取值如 "traffic-analysis" / "orchestrator" / "exploitation" / "inspector"，
// 便于按角色维度统计成本和路由生效情况。
