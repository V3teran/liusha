...
type Profile interface {
	...
	Onboard(ctx context.Context, in BriefInput) ([]explorationgraph.TargetRef, error)
}
...
func (r *Registry) Onboard(ctx context.Context, in BriefInput) ([]explorationgraph.TargetRef, bool) {
	var all []explorationgraph.TargetRef
