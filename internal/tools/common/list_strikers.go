...
func (a ListStrikers) ParametersJSON() json.RawMessage {
...
func (a ListStrikers) Execute(_ context.Context, _ json.RawMessage) (toolfx.Result, error) {
	if a.Registry == nil {
		return toolfx.Result{}, errors.New("list_strikers: Registry 未注入")
	}
