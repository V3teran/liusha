 ...
 * 按 hunter_id 分组折叠（<details>），点开展示完整 16 字段（含 messages / result jsonb）。
 ...
 * @param {{owner_id: string, total: number, groups: Array<{hunter_id: string, count: number, invocations: Array}>}} data
 */
