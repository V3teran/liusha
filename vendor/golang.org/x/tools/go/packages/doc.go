...
interpreted as query executors.

Two query executors are currently supported: "file" and "pattern".
...
to ensure that x is not interpreted as a query executor if it contains '='.

All other query executors are reserved for future use and currently
