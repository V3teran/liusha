...
--   - hunter      = 每次 hunter ReAct 运行的持久化记录（commander 或 striker）
--   - role enum   = tracker / commander / striker（inspector 旁路不入表）
--
...
ALTER INDEX agent_task_commander_id_idx RENAME TO hunter_commander_id_idx;
...
ALTER TABLE hunter RENAME CONSTRAINT agent_task_commander_id_fkey TO hunter_commander_id_fkey;
