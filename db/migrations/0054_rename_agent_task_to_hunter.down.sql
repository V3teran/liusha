...
ALTER TABLE hunter RENAME CONSTRAINT hunter_orchestrator_id_fkey TO agent_task_orchestrator_id_fkey;
...
ALTER INDEX hunter_orchestrator_id_idx RENAME TO agent_task_orchestrator_id_idx;
